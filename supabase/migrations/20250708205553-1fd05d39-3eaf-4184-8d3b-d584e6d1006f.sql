-- Remover constraint unique do path para permitir múltiplos métodos
ALTER TABLE public.api_endpoints DROP CONSTRAINT IF EXISTS api_endpoints_path_key;

-- Inserir endpoints da API
