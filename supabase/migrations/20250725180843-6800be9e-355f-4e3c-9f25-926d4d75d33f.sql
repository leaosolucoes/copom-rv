-- Substituir o trigger para fazer chamada direta à API Evolution
...
-- Nova função que faz chamada direta à API Evolution
...
CREATE TRIGGER send_whatsapp_direct_trigger
  ...
  FOR EACH ROW
  EXECUTE FUNCTION public.send_whatsapp_direct();