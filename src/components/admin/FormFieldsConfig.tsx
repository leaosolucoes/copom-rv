    ...
    try {
      ...
      if (data?.value) {
        ...
        const defaultFields: FormField[] = [
          ...
          { 
            id: '4', name: 'occurrence_type', label: 'Tipo de Ocorrência', 
            type: 'select', options: ['Som Alto', 'Música Alta', 'Festa', 'Construção', 'Outros'], 
            required: true, visible: true, order_index: 1, section: 'occurrence' 
          },
          { 
            id: '5', name: 'occurrence_address', label: 'Endereço da Ocorrência', 
            type: 'text', required: true, visible: true, order_index: 2, section: 'occurrence' 
          },
          { 
            id: '6', name: 'narrative', label: 'Narrativa da Denúncia', 
            type: 'textarea', required: true, visible: true, order_index: 1, section: 'complaint' 
          }
        ];
        setFields(defaultFields);
        await saveFieldsConfig(defaultFields);
      }
    } catch (error) {
